...
public class LuatgiaothongActivity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("hoclythuyet").child("luatgt");
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("LUẬT GIAO THÔNG");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intbackActivity = new Intent(LuatgiaothongActivity.this, LyThuyetActivity.class);
