...
public class SahinhActivity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("hoclythuyet").child("sahinh");
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("SA HÌNH");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intbackActivity = new Intent(SahinhActivity.this, LyThuyetActivity.class);
