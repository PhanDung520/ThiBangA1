...
public class QuestionThiAdapter extends PagerAdapter {
    Context context;
    List<QuestionData> questionDataList;
    int socau = 0;


    public QuestionThiAdapter(Context context, List<QuestionData> questionDataList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        /*if(questionDataList.size()-getCount()==0){
            QuestionData data = new QuestionData();
            data.setSocaudung(""+socau);
        }*/
