...
public class DethiSo3Activity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("dethi").child("deso3");
    ...
    private void showdialog() {
        final Dialog dialog = new Dialog(DethiSo3Activity.this);
        ...
        btnDongy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DethiSo3Activity.this,ThiActivity.class);
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("ĐỀ SỐ 3");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intbackActivity = new Intent(DethiSo3Activity.this, ThiActivity.class);
