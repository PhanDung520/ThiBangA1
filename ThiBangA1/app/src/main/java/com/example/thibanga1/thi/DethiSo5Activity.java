...
public class DethiSo5Activity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("dethi").child("deso5");
    ...
    private void showdialog() {
        final Dialog dialog = new Dialog(DethiSo5Activity.this);
        ...
        btnDongy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DethiSo5Activity.this,ThiActivity.class);
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("ĐỀ SỐ 5");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intbackActivity = new Intent(DethiSo5Activity.this, ThiActivity.class);
