...
public class DethiSo1Activity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    Button btnNext,btnPrevious,btnNopbai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("dethi").child("deso1");
    ...
    private void showdialog() {
        final Dialog dialog = new Dialog(DethiSo1Activity.this);
        ...
        btnDongy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DethiSo1Activity.this,ThiActivity.class);
    ...
    public void backactivity(){
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intbackActivity = new Intent(DethiSo1Activity.this, ThiActivity.class);
