...
public class DethiSo2Activity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("dethi").child("deso2");
    ...
    private void showdialog() {
        final Dialog dialog = new Dialog(DethiSo2Activity.this);
        ...
        btnDongy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DethiSo2Activity.this,ThiActivity.class);
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("ĐỀ SỐ 2");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intbackActivity = new Intent(DethiSo2Activity.this, ThiActivity.class);
