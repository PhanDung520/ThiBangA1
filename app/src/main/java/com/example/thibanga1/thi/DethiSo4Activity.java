...
public class DethiSo4Activity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionRef = FirebaseDatabase.getInstance().getReference("dethi").child("deso4");
    ...
    private void showdialog() {
        final Dialog dialog = new Dialog(DethiSo4Activity.this);
        ...
        btnDongy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DethiSo4Activity.this,ThiActivity.class);
    ...
    public void backactivity(){
        ...
        tbbackactivity.setTitle("ĐỀ SỐ 4");
        ...
        tbbackactivity.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intbackActivity = new Intent(DethiSo4Activity.this, ThiActivity.class);
